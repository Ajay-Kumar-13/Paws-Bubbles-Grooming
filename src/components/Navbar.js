                ...
                <div className="container d-flex mt-4 raleWay goals">
                    <div className="w-50 p-2">
                        <ChangingProgressProvider values={[0, 90]}>
                            {(percentage) => (
                                <CircularProgressbar strokeWidth={8} value={percentage} styles={{text: {fontFamily: ' "roboto", sans-serif', fill: 'white'}, path: {strokeLinecap: 'butt', stroke: '#cbda75'} }} text={`${percentage}%`} />
                            )}
